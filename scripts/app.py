...
import random
import logging
from scripts.utils import load_file, generate_password, generate_email, validate_email, generate_user_agent, get_current_time, save_address_info, generate_display_info
from scripts.address import get_address
...
API_KEYS = load_file('../data/api_keys.txt')
counter = 1
